...
def main() -> None:
  ...
  ap.add_argument("route", help="route prefix, e.g. 00000011")
  ap.add_argument("--dir", required=True, help="directory holding <route>--N/ segments")
  args = ap.parse_args()

  root = pathlib.Path(args.dir)
  segs = sorted(root.glob(f"{args.route}--*/rlog.zst"),
